  ...
  const cases = [
    {
      ...
      title: "Building, failing, rebuilding, and then hitting $30k MRR in a year",
      revenue: "$30K MRR",
      company: "Company Name"
    },
    {
      founder: "FOUNDER NAME",
      title: "Growing to an 8-figure ARR in three years with savings-based pricing",
      revenue: "$800K+ MRR",
      company: "Company Name"
    },
    {
      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {cases.map((item, index) => (
            <div 
              key={index} 
              className="bg-card p-6 rounded-[20px] flex flex-col justify-between min-h-[200px] hover:shadow-md transition-shadow cursor-pointer border border-transparent dark:border-white/5"
            >
              <div>
                <p className="text-[10px] font-bold text-foreground/40 uppercase tracking-wider mb-3">
                  {item.founder}
                </p>
