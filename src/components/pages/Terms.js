...
export default function Terms() {
  ...
  return (
    <div className="min-h-screen bg-background transition-colors duration-300">
      ...
      <section className="max-w-7xl mx-auto py-16 px-6 md:px-12 lg:px-16">
        {/*
          Rich Text Editor Editor markup render karne ke liye safely inject wrapper.
          Arbitrary selectors loop paragraphs aur subheadings ka markup code design tight aur static jaisa hi rakhega.
        */}
        <div 
