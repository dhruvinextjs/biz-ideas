      ...
      <div className="bg-gray-100 dark:bg-[#100A44] border-b border-gray-200 dark:border-white/10 pt-28 pb-12 px-4 md:px-8">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-8 items-center justify-between">
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-3">
              <span className="flex items-center gap-2 text-icon bg-gray-300 dark:bg-[#3E3F65] px-4 py-2 rounded-md text-sm font-normal">
                <PiSquaresFourBold size={16} className="text-icon" /> HealthTech
                SaaS
              </span>
              <span className="flex items-center gap-2 text-icon bg-gray-300 dark:bg-[#3E3F65] px-4 py-2 rounded-md text-sm font-normal">
          ...
          <div className="w-full lg:w-[450px] shrink-0 h-[280px] relative rounded-2xl overflow-hidden shadow-lg border border-gray-200 dark:border-white/5">
            <Image
              src="/images/app-ideas-detail.png" // Apni image path se replace karein
              alt="Startup process"
              fill
        ...
        <div className="flex-1 space-y-10">
          ...
          <div className="bg-[#370D25] border border-[#BD0B0B] rounded-xl p-6">
            ...
            <p className="text-sm text-white leading-relaxed">
              Many users struggle to maintain a healthy lifestyle due to lack of
              consistency, guidance, and data tracking. Using multiple apps for
              fitness, diet, and sleep creates confusion and reduces long-term
              engagement. Personalized coaching is expensive and not accessible
              to everyone.
            </p>
          </div>
          ...
          <div className="bg-[#082846] border border-[#1C8D99] rounded-xl p-6">
            ...
            <p className="text-sm text-white leading-relaxed">
              An all-in-one fitness and wellness app that tracks physical
              activity, diet, sleep, and mental health in a single dashboard.
              The app uses AI to generate customized workout plans, meal
              suggestions, and daily health insights, making fitness simple and
              accessible.
            </p>
          </div>
          ...
          <section>
            ...
            <ul className="space-y-3 text-sm md:text-base text-gray-700 dark:text-gray-300">
              <li className="dark:text-[#BACCDE] text-sm">
                ...
                Users enter their goals, fitness level, and health preferences.
              </li>
              <li className="dark:text-[#BACCDE] text-sm">
                <strong className="text-icon font-semibold">
                  2.Personalization :
                </strong>{" "}
                AI creates customized workout, diet, and wellness plans.
              </li>
              <li className="dark:text-[#BACCDE] text-sm">
                <strong className="text-icon font-semibold">
                  3. Tracking :
                </strong>{" "}
                App tracks workouts, calories, sleep, and daily habits
                automatically.
              </li>
              <li className="dark:text-[#BACCDE] text-sm">
                <strong className="text-icon font-semibold">
                ...
                Dashboard provides progress reports, tips, and improvement
                suggestions.
              </li>
            </ul>
          </section>
