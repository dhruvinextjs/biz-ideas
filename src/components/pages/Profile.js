    ...
    <main className="min-h-screen bg-background text-foreground pt-24 md:pt-28">
      <div className="max-w-2xl mx-auto px-4 py-10 space-y-8">
        ...
        <div className="pb-6 border-b border-dashed border-icon/20 relative">
          <button onClick={openBio}
            className="absolute top-0 right-0 flex items-center gap-1.5 text-sm border border-[#36568D] text-icon rounded-lg px-3 py-1.5 hover:opacity-80 transition-all">
            <TbEdit size={14} /> Edit
          </button>
          <div className="flex items-start gap-5">
            <div className="relative flex-shrink-0">
              ...
              {/* <span className="absolute bottom-0 right-0 w-4 h-4 rounded-full bg-green-400 border-2 border-background" /> */}
            </div>
            <div className="flex-1 min-w-0 pt-5">
              <h1 className="text-xl font-bold text-icon leading-tight">{profile.name}</h1>
              <p className="text-sm text-icon opacity-80 mt-1 leading-relaxed">{profile.bio}</p>
            </div>
          </div>
        </div>
